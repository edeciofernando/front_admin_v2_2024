      ...
      <aside id="default-sidebar" className="fixed top-30 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-blue-200 dark:bg-blue-600">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link href="/principal/cadfilmes" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Cadastro de Filmes</span>
              </Link>
            </li>
          </ul>
        </div>
